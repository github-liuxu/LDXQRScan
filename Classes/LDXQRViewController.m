...
@interface LDXQRViewController ()<AVCaptureMetadataOutputObjectsDelegate>{
    int num;
    BOOL upOrdown;
    NSTimer * timer;
...
@implementation LDXQRViewController
...
- (IBAction)tapLocalScan:(UIButton *)sender {
    NSLog(@"识别本地图片");
    NSString *result = [LDXQRCodeUtil readQRCodeFromImage:[UIImage imageNamed:@"QRImage"]];
